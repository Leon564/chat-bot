...
import { NodeType } from '../../common/schemas/graph-node.schema';
...
export class GraphContextService {
  ...
  /** Agrupa por tipo de relación para que el modelo distinga "le gusta" de "ya le recomendé". */
  private render(displayName: string, edges: TopEdge[], highlight: string | null): string {
  ...
  /** Recorta al límite de palabra completo más cercano por debajo de `MAX_CHARS`. */
